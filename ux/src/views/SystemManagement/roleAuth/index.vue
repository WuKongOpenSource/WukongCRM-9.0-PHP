      ...
      <div
        ...
        <div class="role-nav-box">
          <div
            ...
            {{ item.title }}
            <div
              v-if="item.types != 1 && item.types != 7"
              class="icon-close">
              <el-dropdown
                trigger="click"
...
export default {
  ...
  computed: {
    ...
    showRuleSet() {
      if (this.roleActive) {
        return this.roleActive.types != 1 && this.roleActive.types != 7
      }
    ...
    showReminder() {
      if (this.roleActive) {
        return this.roleActive.types == 7
      }
  ...
  methods: {
     ...
     */
    getReminderContent() {
      if (this.roleActive && this.roleActive.types == 7) {
