  ...
  <transition name="slide-fade">
    <el-card
      ...
      <div
        ...
        class="clear-fix">
        <div
          v-if="taskData && taskData.work_name"
          class="work-name">{{ taskData.work_name }}</div>
      ...
      <div
        ...
        <!-- 归档 -->
        <div
          v-if="taskData.is_archive == 1"
          class="particulars-extraContent">
          <span class="text">该任务已于 {{ taskData.archive_time | filterTimestampToFormatTime }} 被归档。</span>
          <el-button
            type="primary"
            class="border-radius"
            size="mini"
        ...
        <div
          ...
          class="particulars-extraContent">
          <span class="text">该任务已于 {{ taskData.hidden_time | filterTimestampToFormatTime }} 被放入回收站。</span>
          <el-button
            type="primary"
            class="border-radius"
            size="mini"
                  ...
                  <div
                    ...
                    <div class="rt">
                      <flexbox class="rt-box">
                        <div
                          v-if="item.stop_time"
                          class="bg-color task-bg-color">{{ item.stop_time | moment("MM-DD") }} 截止</div>
                        <div
                          v-photo="item"
                          v-lazy:background-image="$options.filters.filterUserLazyImg(item.thumb_img)"
              ...
              <div
                ...
                <template v-if="activityList.length != 0">
                  <flexbox
                    ...
                    <div class="activity-time">{{ item.create_time | moment("MM-DD HH:mm") }}</div>
                  </flexbox>
                </template>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    getDetail() {
      this.loading = true
      workTaskReadAPI({ task_id: this.id })
        .then(res => {
